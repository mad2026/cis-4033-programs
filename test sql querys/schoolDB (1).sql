...
MySQL - 10.1.25-MariaDB : Database - mis3053schooldb
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`mis3053schooldb` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `mis3053schooldb`;

/*Table structure for table `classrooms` */

DROP TABLE IF EXISTS `classrooms`; /* done with classroom*/
...
DROP TABLE IF EXISTS `courses`; /* done with course*/
...
('S9','MIS3053','FALL2017A',NULL),
('S9','PSY3063','SPRING2010A','A');

/*Table structure for table `professors` */

DROP TABLE IF EXISTS `professors`; /* done with professor*/
...
('F1','Lisa Myers','702 N Main St, Tulsa, OK 74133','CIS','Ph.D'),
...
('F6','Susan Sanders','9798 S Aspen Ave, Broken Arrow, OK, 74012','Computer Science','Ph.D'),
('F7','Laura Jones','6543 E 121st St, Bixby, OK, 74112','Mechanical Engineering','Ph.D'),
('F8','George Daniels','2984 S Toledo Ave, Tulsa, OK, 74138','CIS','Ph.D'),
('F9','Grant Russell','7923 S Memorial Ave, Tulsa, OK, 74137','Accounting','Ph.D'),
('M1','George Daniels','4567 S. Tudor Drive, Tulsa, OK 73198','Computer Science','Ph.D. ');
...
('CS1043','SPRING2011A','13:00:00','MW','2013-01-12','2013-05-09','KEPM6'),
...
('HIST2553','SPRING2010B','15:15:00','TTH','2010-01-11','2010-05-06','CM117'),
('MATH2014','SPRING2010B','09:30:00','TTH','2010-01-11','2010-05-06','KEPM6'),
('MGMT3003','SPRING2010B','11:00:00','MWF','2010-01-11','2010-05-06','HELM101'),
('MIS3053','Fall2017A','14:00:00','TTH','2017-08-19','2017-12-08','HELM316'),
...
DROP TABLE IF EXISTS `students`; /* done with student*/
